			...
			<div className={styles.content}>
				<div className={styles.top}>
					...
					<div className={styles.media_icons}>
						<a
							href="https://www.facebook.com/markos.bahgat.376"
							rel="noreferrer"
							target="_blank"
						>
						...
						<a
							href="https://twitter.com/bahgat_markos"
							rel="noreferrer"
							target="_blank"
						>
						...
						<a
							href="https://www.instagram.com/markos_bahgat"
							rel="noreferrer"
							target="_blank"
						>
						...
						<a
							href="https://www.linkedin.com/in/markos-bahgat-9a7178216"
							rel="noreferrer"
							target="_blank"
						>
			...
			<div className={styles.bottom_details}>
				<div className={styles.bottom_text}>
					<span className={styles.copyright_text}>
						Copyright © 2021 <a href="#">MarkosBaghat.</a>All rights reserved
					</span>
