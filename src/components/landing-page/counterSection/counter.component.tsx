    ...
    <div>
        <div className={styles.main_container}>
            <div className={styles.counter_container}>
                ...
                <h1>Users</h1>
                <span>we serve millions of users around the world everyday as you can see</span>
            </div><hr/>
            <div className={styles.counter_container}>
                <i className="fa-solid fa-bag-shopping"></i>
                <h3>{(counter + 105000).toLocaleString()}</h3>
                <h1>Products</h1>
                <span>we have alot of producct to shop freerly mother fucker</span>
            </div><hr/>
            <div className={styles.counter_container}>
                <i className="fa-solid fa-truck-fast"></i>
                <h3>{(counter + 1000).toLocaleString()}</h3>
                <h1>Shipped Product</h1>
                <span>Thousend of products shipped every day</span>
            </div>
        </div>
    </div>
  )
