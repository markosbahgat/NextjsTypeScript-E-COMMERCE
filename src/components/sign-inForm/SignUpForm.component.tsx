          ...
          <main  className={styles.login_block}>
              ...
              <div className={styles.input_container}>
                ...
                <div className={styles.input_container}>
                    ...
                    <input type="email" id={styles[`${errors.email && "error"}`]} className={styles.input_field} placeholder='Enter your email' {...register("email", {  required: true, pattern: /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/i })}/>
                    <i className="fas fa-envelope fa-lg"></i>
                {errors.email?.type === 'required' && <span color="red">Please Confirm Email</span>}
                </div>
                <div className={styles.input_container}>
                        <label className={styles.input_label}>User Name</label>
                        <input id={styles[`${errors.username && "error"}`]}  className={styles.input_field} placeholder='Enter your userName' {...register("username", {  required: true })} type="text"/>
                ...
                <div className={styles.input_container}>
                      ...
                      <input  id={styles[`${errors.password && "error"}`]} type={showPassword1 ? 'text' : 'password'}  className={styles.input_field} placeholder='Enter your password' {...register("password", {  required: true, pattern: /^[A-Za-z]+$/i })}/>
                      <i className="fas fa-lock fa-lg"></i>
